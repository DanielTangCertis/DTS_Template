...
const HomePage: React.FC = () => {
  ...
  return (
    <HomeContainer>
      ...
      {headerState.showUI && (headerState.showLayerTree || headerState.showAnimation) && (
      ...
      {/* Main content area - only show when no overlays are active */}
      {digitalTwinState.playerIsReady && 
       headerState.showUI && 
       !(headerState.showLayerTree || headerState.showAnimation || headerState.showWeather) && (
        <>
          {/* Router navigation */}
          <RouterNav />
