...
// Sample data for crowd flow chart (converted from Vue options)
const crowdFlowData = [
  {
    id: "Inflow",
    color: "#00c484",
...
const categoryData = [
  { category: "cat1", value: 232 },
  { category: "cat2", value: 251 },
  { category: "cat3", value: 255 },
  { category: "cat4", value: 217 },
  { category: "cat5", value: 225 },
];
